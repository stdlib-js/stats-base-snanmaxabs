...
```javascript
import snanmaxabs from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-snanmaxabs@v0.1.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/stats-base-snanmaxabs/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-base-snanmaxabs/actions/workflows/test.yml?query=branch:v0.1.1
